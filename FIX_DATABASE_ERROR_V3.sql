...
-- This script handles report_view_mat as a regular VIEW.
...
-- 2. Drop Views that depend on 'periode' or 'periode_bulan'
...
-- 5. Recreate the VIEW (not materialized)
...
-- 6. Drop unnecessary refresh function
DROP FUNCTION IF EXISTS refresh_report_view();
